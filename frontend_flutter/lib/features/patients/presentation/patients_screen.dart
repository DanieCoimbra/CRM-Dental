        ...
        children: [
          ...
          LayoutBuilder(
            builder: (context, constraints) {
              ...
              final insuranceDropdown = Container(
              ...
              return Container(
                padding: EdgeInsets.symmetric(horizontal: isNarrow ? 16.0 : 20.0, vertical: 16.0),
          ...
          child: Column(
            ...
            children: [
              ...
              Row(
                ...
                children: [
                  TextButton.icon(
                    icon: const Icon(LucideIcons.stethoscope, size: 16, color: Color(0xFF2563EB)),
                    label: const Text('Prontuário', style: TextStyle(color: Color(0xFF2563EB), fontWeight: FontWeight.bold)),
                    onPressed: () => context.go('/patients/${p.id}/emr'),
                  ),
                  const SizedBox(width: 8),
                  IconButton(
